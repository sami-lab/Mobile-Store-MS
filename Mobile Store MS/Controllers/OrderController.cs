...
namespace Mobile_Store_MS.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public OrderController(IorderRepositery IorderRepository, ApplicationDbContext context, IHostingEnvironment hosting,UserManager<ApplicationUser> _userManager)
        {
        ...
        public ActionResult Search(string searchList,string Name,DateTime time,int Month,string RefNo,Status? OrderStatus,int? store_id)
        {
        ...
        public ActionResult Sort(string sortBy,string order,int? store_id)
        {   
        
            int pageNo = int.Parse(TempData["CurrentPage"] != null? TempData["CurrentPage"].ToString(): "1");
            double TotalOrders = 0,limit= 30;
